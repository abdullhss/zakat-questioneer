      ...
      <section className="mx-auto flex min-h-screen w-full max-w-6xl items-center justify-center px-4 py-12 sm:px-6">
        <div className="form-pattern-bg w-full max-w-4xl rounded-3xl p-6 shadow-2xl sm:p-10">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-700">
            ...
            لتقييم منصة وصل الليبية. تهدف هذه الاستبانة إلى رصد التحديات وتطوير المنصة بما يخدم التغلب على هذه التحديات.
          </p>
          ...
          >
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    placeholder="مثال: موظف , رجل أعمال , ناشط , باحث ."
                  />
                  {errors.role && (
            ...
            <section className="space-y-4">
              ...
              <p className="text-sm leading-7 text-slate-700">
                ...
                وإشهارها بحضور نخبة من المسؤولين ونخبة من الكفاءات في مجالات تقنية المعلومات، والأنظمة المالية، بالإضافة إلى مستشارين شرعيين متخصصين في فقه الزكاة.
              </p>
